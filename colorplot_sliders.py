...
def get_trans(a, m1, m2, c1, c2, c12, d1, d2):
    ...
    return k_y, omega, gamma, trans_coeff, gamma_mask, trans_coeff_mask
...
if __name__ == '__main__':
    ...
    k_y, omega, gamma, trans_coeff, gamma_mask, trans_coeff_mask = get_trans(a=a, m1=slider_m1.val, m2=slider_m2.val,
    ...
    def update(val):
        ...
        k_y, omega, gamma, trans_coeff, gamma_mask, trans_coeff_mask = get_trans(a=a, m1=slider_m1.val,
                                                                                 m2=slider_m2.val,
                                                                                 c1=slider_c1.val, c2=slider_c2.val,
                                                                                 c12=slider_c12.val,
                                                                                 d1=slider_d1.val, d2=slider_d2.val)
